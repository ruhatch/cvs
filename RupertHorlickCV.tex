...
\begin{document}
  ...
  \section{Experience}
    ...
    \cventry[0.5em]{June 2020 -- Dec 2020}{Senior Engineer}{Regen Network
      ...
      implement the core product, an ecocredit trading platform. Contributed to
      community infrastructure of Cosmos SDK through bug fixing, code review,
      and upstreaming useful libraries.}
...
%    }
  ...
  \section{Other}
    ...
    \cvdoubleitem{Programming Languages}{\small
      \begin{compactitem}
        \item Haskell, Rust, OCaml, Hoon
        \item Javascript, Nix, Agda, Java
